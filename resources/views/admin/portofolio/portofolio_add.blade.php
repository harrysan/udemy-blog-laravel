            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Portofolio Page</h4>
                        ...
                        <form method="POST" action="{{ route('store.portofolio') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="portofolio_name" class="form-control" type="text" id="portofolio_name">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="portofolio_title" class="form-control" type="text" id="portofolio_title">
                            ...
                            <input type="submit" value="Insert Portofolio Data" class="btn btn-info waves-effect waves-light">
                        </form>
