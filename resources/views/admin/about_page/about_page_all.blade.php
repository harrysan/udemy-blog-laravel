                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('update.about', $aboutpage->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="title" class="form-control" value="{{ $aboutpage->title }}" type="text" id="title">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="short_title" class="form-control" value="{{ $aboutpage->short_title }}" type="text" id="short_title">
                                </div>
                            </div>
