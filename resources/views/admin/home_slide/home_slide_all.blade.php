                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('update.slider', $homeslide->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="title" class="form-control" value="{{ $homeslide->title }}" type="text" id="title">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="short_title" class="form-control" value="{{ $homeslide->short_title }}" type="text" id="short_title">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="video_url" class="form-control" value="{{ $homeslide->video_url }}" type="text" id="video_url">
                                </div>
                            </div>
